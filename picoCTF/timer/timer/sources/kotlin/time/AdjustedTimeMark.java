...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1312elapsedNowUwyO8pc() {
        return Duration.m1354minusLRDsOJo(this.mark.mo1312elapsedNowUwyO8pc(), getAdjustment());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1313plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1355plusLRDsOJo(getAdjustment(), duration), null);
    }
}
