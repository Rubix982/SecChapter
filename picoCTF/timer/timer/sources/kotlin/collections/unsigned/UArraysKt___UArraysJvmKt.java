...
class UArraysKt___UArraysJvmKt {
    ...
    private static final int m512elementAtqFRl0hI(int[] elementAt, int index) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UIntArray.m188getpVg5ArA(elementAt, index);
    }

    /* renamed from: elementAt-r7IrZao, reason: not valid java name */
    private static final long m513elementAtr7IrZao(long[] elementAt, int index) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return ULongArray.m266getsVKNKU(elementAt, index);
    }

    /* renamed from: elementAt-PpDY95g, reason: not valid java name */
    private static final byte m510elementAtPpDY95g(byte[] elementAt, int index) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UByteArray.m110getw2LRezQ(elementAt, index);
    }

    /* renamed from: elementAt-nggk6HY, reason: not valid java name */
    private static final short m511elementAtnggk6HY(short[] elementAt, int index) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UShortArray.m370getMh2AYeg(elementAt, index);
    }

    /* renamed from: asList--ajY-9A, reason: not valid java name */
    public static final List<UInt> m498asListajY9A(int[] asList) {
        Intrinsics.checkNotNullParameter(asList, "$this$asList");
        return new UArraysKt___UArraysJvmKt$asList$1(asList);
    }

    /* renamed from: asList-QwZRm1k, reason: not valid java name */
    public static final List<ULong> m500asListQwZRm1k(long[] asList) {
        Intrinsics.checkNotNullParameter(asList, "$this$asList");
        return new UArraysKt___UArraysJvmKt$asList$2(asList);
    }

    /* renamed from: asList-GBYM_sE, reason: not valid java name */
    public static final List<UByte> m499asListGBYM_sE(byte[] asList) {
        Intrinsics.checkNotNullParameter(asList, "$this$asList");
        return new UArraysKt___UArraysJvmKt$asList$3(asList);
    }

    /* renamed from: asList-rL5Bavg, reason: not valid java name */
    public static final List<UShort> m501asListrL5Bavg(short[] asList) {
        Intrinsics.checkNotNullParameter(asList, "$this$asList");
    ...
    public static /* synthetic */ int m503binarySearch2fe2U9s$default(int[] iArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i3 = UIntArray.m189getSizeimpl(iArr);
        }
        return UArraysKt.m502binarySearch2fe2U9s(iArr, i, i2, i3);
    }

    /* renamed from: binarySearch-2fe2U9s, reason: not valid java name */
    public static final int m502binarySearch2fe2U9s(int[] binarySearch, int element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UIntArray.m189getSizeimpl(binarySearch));
        int low = fromIndex;
        int high = toIndex - 1;
        while (low <= high) {
            int mid = (low + high) >>> 1;
    ...
    public static /* synthetic */ int m507binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m267getSizeimpl(jArr);
        }
        return UArraysKt.m506binarySearchK6DWlUc(jArr, j, i, i2);
    }

    /* renamed from: binarySearch-K6DWlUc, reason: not valid java name */
    public static final int m506binarySearchK6DWlUc(long[] binarySearch, long element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, ULongArray.m267getSizeimpl(binarySearch));
        int low = fromIndex;
        int high = toIndex - 1;
        while (low <= high) {
            int mid = (low + high) >>> 1;
    ...
    public static /* synthetic */ int m509binarySearchWpHrYlw$default(byte[] bArr, byte b, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UByteArray.m111getSizeimpl(bArr);
        }
        return UArraysKt.m508binarySearchWpHrYlw(bArr, b, i, i2);
    }

    /* renamed from: binarySearch-WpHrYlw, reason: not valid java name */
    public static final int m508binarySearchWpHrYlw(byte[] binarySearch, byte element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UByteArray.m111getSizeimpl(binarySearch));
    ...
    public static /* synthetic */ int m505binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m371getSizeimpl(sArr);
        }
        return UArraysKt.m504binarySearchEtDCXyQ(sArr, s, i, i2);
    }

    /* renamed from: binarySearch-EtDCXyQ, reason: not valid java name */
    public static final int m504binarySearchEtDCXyQ(short[] binarySearch, short element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UShortArray.m371getSizeimpl(binarySearch));
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int m189getSizeimpl = UIntArray.m189getSizeimpl(sumOf);
        for (int i = 0; i < m189getSizeimpl; i++) {
            int element = UIntArray.m188getpVg5ArA(sumOf, i);
            BigDecimal add = sum.add(selector.invoke(UInt.m123boximpl(element)));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        BigDecimal sum = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(sum, "valueOf(this.toLong())");
        int m267getSizeimpl = ULongArray.m267getSizeimpl(sumOf);
        for (int i = 0; i < m267getSizeimpl; i++) {
            long element = ULongArray.m266getsVKNKU(sumOf, i);
            BigDecimal add = sum.add(selector.invoke(ULong.m201boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal sum = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(sum, "valueOf(this.toLong())");
        int m111getSizeimpl = UByteArray.m111getSizeimpl(sumOf);
        for (int i = 0; i < m111getSizeimpl; i++) {
            byte element = UByteArray.m110getw2LRezQ(sumOf, i);
            BigDecimal add = sum.add(selector.invoke(UByte.m47boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal sum = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(sum, "valueOf(this.toLong())");
        int m371getSizeimpl = UShortArray.m371getSizeimpl(sumOf);
        for (int i = 0; i < m371getSizeimpl; i++) {
            short element = UShortArray.m370getMh2AYeg(sumOf, i);
            BigDecimal add = sum.add(selector.invoke(UShort.m307boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(int[] sumOf, Function1<? super UInt, ? extends BigInteger> selector) {
        ...
        for (int i = 0; i < m189getSizeimpl; i++) {
            int element = UIntArray.m188getpVg5ArA(sumOf, i);
            BigInteger add = sum.add(selector.invoke(UInt.m123boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(long[] sumOf, Function1<? super ULong, ? extends BigInteger> selector) {
        ...
        for (int i = 0; i < m267getSizeimpl; i++) {
            long element = ULongArray.m266getsVKNKU(sumOf, i);
            BigInteger add = sum.add(selector.invoke(ULong.m201boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(byte[] sumOf, Function1<? super UByte, ? extends BigInteger> selector) {
        ...
        for (int i = 0; i < m111getSizeimpl; i++) {
            byte element = UByteArray.m110getw2LRezQ(sumOf, i);
            BigInteger add = sum.add(selector.invoke(UByte.m47boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(short[] sumOf, Function1<? super UShort, ? extends BigInteger> selector) {
        ...
        for (int i = 0; i < m371getSizeimpl; i++) {
            short element = UShortArray.m370getMh2AYeg(sumOf, i);
            BigInteger add = sum.add(selector.invoke(UShort.m307boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
