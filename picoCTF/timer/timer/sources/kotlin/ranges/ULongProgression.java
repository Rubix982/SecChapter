...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public boolean equals(Object other) {
        return (other instanceof ULongProgression) && ((isEmpty() && ((ULongProgression) other).isEmpty()) || (getFirst() == ((ULongProgression) other).getFirst() && getLast() == ((ULongProgression) other).getLast() && this.step == ((ULongProgression) other).step));
    }
    ...
    public int hashCode() {
        ...
        int m207constructorimpl = ((((int) ULong.m207constructorimpl(getFirst() ^ ULong.m207constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m207constructorimpl(getLast() ^ ULong.m207constructorimpl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return ((int) (j ^ (j >>> 32))) + m207constructorimpl;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m252toStringimpl(getFirst()));
            sb.append("..");
            sb.append((Object) ULong.m252toStringimpl(getLast()));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
