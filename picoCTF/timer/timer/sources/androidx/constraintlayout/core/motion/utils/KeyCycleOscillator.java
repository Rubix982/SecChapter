...
public abstract class KeyCycleOscillator {
    ...
    public void setup(float pathLength) {
        ...
        if (count != 0) {
            ...
            double[][] values = (double[][]) Array.newInstance((Class<?>) double.class, count, 3);
    ...
    public static class CycleOscillator {
        ...
        public void setup(float pathLength) {
            ...
            double[][] splineValues = (double[][]) Array.newInstance((Class<?>) double.class, this.mPosition.length, 3);
