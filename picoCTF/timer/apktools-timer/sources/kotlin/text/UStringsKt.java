...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m129constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m47boximpl(UByte.m53constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m129constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m307boximpl(UShort.m313constructorimpl((short) data));
    }
