...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public boolean equals(Object other) {
        return (other instanceof UIntProgression) && ((isEmpty() && ((UIntProgression) other).isEmpty()) || (getFirst() == ((UIntProgression) other).getFirst() && getLast() == ((UIntProgression) other).getLast() && this.step == ((UIntProgression) other).step));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m174toStringimpl(getFirst()));
            sb.append("..");
            sb.append((Object) UInt.m174toStringimpl(getLast()));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
